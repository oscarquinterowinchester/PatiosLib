...
public class ItinerarioGuardiasContExternosRentas2 extends javax.swing.JFrame {
    ...
    public ItinerarioGuardiasContExternosRentas2() {
        try {
            initComponents();
            ...
            ConfigLib.setDatePicker(txtFechafin, 14);
            ConfigLib.setDatePicker(txtFechaini, 14);

            ConfigLib.setFormattedHM(txtInicio, 14);
            ConfigLib.setFormattedHM(txtFinal, 14);
