...
public class ItinerarioGuardiasContExternosRentas extends javax.swing.JFrame {
    ...
    ArrayList<String> conceptofacturacionid = new ArrayList<>();
    
    
    WebDateField FechaFinal = new WebDateField ( new Date () );

    public ItinerarioGuardiasContExternosRentas() {
        try {
            initComponents();
            ...
            ConfigLib.WebDate(FechaFinal, 12);
            ...
            FechaFinal.setPreferredWidth(100);
            FechaFinal.setPreferredHeight(30);
            FechaFinal.setFont(new Font("Tahoma", Font.PLAIN, 12));
            FechaFinal.setEditable(false);
            jPanel32.add(FechaFinal);
            ...
            jLabel8.setIcon(new ImageIcon("images\\Rentas.png"));
            ...
            boxFiltroBusqueda.setSelectedItem("Entradas");
            ...
            cargarClientesExternos(cliente1, cliente1id, ""); //
            ...
            cargarPatiosVirtuales(BoxPatios, patiosid, "Todos");

            FillCombo.cargarLocaciones(Orgn, rutaidx, "Todos");

            cargarPatiosVirtuales(Patio, PatioID, "");
            ...
            pEstados6.setVisible(false);
            pEstados1.setVisible(false);
            pEstados3.setVisible(false);
            pEstados7.setVisible(false);
            pEstados12.setVisible(false);
            pEstados2.setVisible(false);
            bActualizar.setVisible(false);
            bContenedores.setVisible(false);
            bContenedores1.setVisible(false);
            jButton1.setVisible(false);
            jButton15.setVisible(false);
            jButton16.setVisible(false);
            jButton21.setVisible(false);
            jCheckBox3.setVisible(false);
            FilterFull.setVisible(false);
            schasis.setVisible(false);
            bControlEquipment.setVisible(false);
...
//    }
    ...
    private void cargarTabla() {
        ...
        } else if(BoxPatios.getSelectedIndex()==0) {
            patio = " and (select renta from patios_tbl where patioID=inventarioexterno_tbl.patioID) is true ";
        }
        ...
        if (permisos) {
            ...
            QUERYAMPL = "select Contenedor, inventarioID,"
                    + "IF(EquipmentProvider=0,'AVAILABLE',(select NCOMERCIAL from clientes_tbl where clienteID=inventarioexterno_tbl.EquipmentProvider)) as Eqprov, "
                    ...
                    + "IF(totalrenta+0>0,totalrenta,ROUND(IFNULL((select costo from perfilcobro_rango "
                    ...
                    + "where inventarioID>0 and TipoEvento=1 and contenedor!=''  " + perfilapplied + "  AND FACTURADO IS NOT TRUE and "
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    temp[0] = cntz + "";
                    temp[1] = rs.getString("inventarioID");
                    temp[2] = rs.getString("Contenedor");
                    temp[3] = rs.getString("cliente");
                    temp[4] = rs.getString("fechaevento");
                    temp[5] = rs.getString("horaevento");
                    temp[6] = rs.getString("daysin");
                    temp[7] = rs.getString("Nota");
                    temp[8] = rs.getString("perfilcobro");
...
//                            }
    ...
    private void initComponents() {
        ...
        txtHLlegada1 = new javax.swing.JFormattedTextField();
        ...
        conceptofacturacion = new javax.swing.JComboBox();
        ...
        dEntradaSalida.setMinimumSize(new java.awt.Dimension(820, 450));
        ...
        jLabel36.setBounds(360, 10, 160, 20);
        ...
        txtHLlegada.setBounds(470, 30, 50, 30);

        jLabel37.setText("Placas MEX");
        jLabel37.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel37.setForeground(new java.awt.Color(51, 51, 51));
        jPanel36.add(jLabel37);
        jLabel37.setBounds(2610, 130, 160, 20);
        ...
        jButton4.setBounds(680, 310, 110, 50);
        ...
        boxEstadoCarga.setBounds(1990, 700, 160, 30);
        ...
        txtPlacasChasis.setBounds(1650, 630, 160, 30);
        ...
        jLabel88.setBounds(1650, 680, 130, 20);
        jPanel36.add(txtSello);
        txtSello.setBounds(2160, 700, 160, 30);
        ...
        boxEstadoPlacas.setBounds(2610, 210, 160, 30);
        ...
        boxPaisPlacas.setBounds(2610, 150, 160, 30);
        ...
        jLabel89.setBounds(1650, 610, 160, 20);
        ...
        jLabel91.setBounds(2500, 680, 160, 20);
        ...
        bEliminarLlegada.setBounds(2350, 780, 160, 30);
        ...
        bLlegada.setBounds(2000, 780, 160, 30);
        ...
        jLabel92.setBounds(2610, 190, 160, 20);
        ...
        txtContenedor.setBounds(190, 30, 160, 30);
        ...
        cliente.setBounds(20, 130, 330, 30);

        txtNombreChofer.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtNombreChoferActionPerformed(evt);
            }
        });
        jPanel36.add(txtNombreChofer);
        txtNombreChofer.setBounds(1990, 540, 330, 30);
        ...
        jLabel100.setBounds(1650, 760, 160, 20);
        ...
        jLabel95.setBounds(1990, 520, 340, 20);
        ...
        boxTamano.setBounds(2500, 700, 160, 30);

        jLabel96.setText("Notas");
        ...
        jLabel96.setBounds(20, 200, 330, 20);
        ...
        jLabel98.setBounds(1680, 260, 180, 20);
        ...
        jLabel99.setBounds(1710, 0, 160, 20);
        jPanel36.add(camiones);
        camiones.setBounds(1990, 480, 160, 30);

        jLabel38.setText("Camion Interno");
        jLabel38.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel38.setForeground(new java.awt.Color(255, 0, 0));
        jPanel36.add(jLabel38);
        jLabel38.setBounds(1820, 460, 160, 20);
        ...
        camionx.setBounds(1820, 480, 160, 30);
        ...
        jPanel36.add(Orgn);
        Orgn.setBounds(1650, 780, 160, 30);
        ...
        jLabel101.setBounds(2330, 460, 160, 20);
        jPanel36.add(placasunidad);
        placasunidad.setBounds(2330, 480, 160, 30);

        jLabel18.setText("Ultimo Bit:");
        jPanel36.add(jLabel18);
        jLabel18.setBounds(2000, 610, 70, 20);
        ...
        NCHASIS.setBounds(2630, 330, 160, 30);
        ...
        jLabel103.setBounds(2630, 310, 160, 20);
        ...
        jLabel104.setBounds(1650, 460, 160, 20);
        jPanel36.add(CARRIER);
        CARRIER.setBounds(1650, 480, 160, 30);
        ...
        edicion.setBounds(360, 330, 290, 20);
        ...
        jLabel102.setBounds(1830, 760, 160, 20);
        jPanel36.add(destino);
        destino.setBounds(1830, 780, 160, 30);
        ...
        jLabel106.setBounds(2670, 630, 120, 20);
        ...
        jPanel36.add(grade);
        grade.setBounds(2670, 650, 120, 30);
        ...
        jLabel107.setBounds(1930, 810, 160, 20);
        jPanel36.add(assignedto);
        assignedto.setBounds(1950, 840, 160, 30);
        ...
        jLabel108.setBounds(20, 10, 160, 20);
        ...
        jLabel109.setBounds(490, 310, 160, 20);

        jLabel1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        jPanel36.add(jLabel1);
        jLabel1.setBounds(350, 310, 320, 50);
        ...
        txtDriverMove.setBounds(1790, 150, 160, 30);
        ...
        jButton19.setBounds(2040, 130, 80, 15);
        ...
        jPanel36.add(Camion);
        Camion.setBounds(2820, 60, 130, 30);
        ...
        jButton10.setBounds(2930, 370, 240, 30);
        ...
        jLabel78.setBounds(610, 110, 90, 15);

        bcamion.setText("webDateField1");
        jPanel36.add(bcamion);
        bcamion.setBounds(2160, 480, 160, 30);
        ...
        jPanel30.setBounds(360, 30, 110, 34);
        jPanel36.add(jSeparator1);
        jSeparator1.setBounds(1730, 440, 1160, 20);
        ...
        boxPaisPlacas1.setBounds(2950, 150, 160, 30);
        ...
        jLabel110.setBounds(2780, 190, 160, 20);
        ...
        boxEstadoPlacas1.setBounds(2780, 210, 160, 30);
        ...
        jLabel111.setBounds(2500, 460, 160, 20);
        jPanel36.add(placasunidad1);
        placasunidad1.setBounds(2500, 480, 160, 30);
        ...
        jLabel113.setBounds(2330, 520, 160, 20);
        ...
        jLabel114.setBounds(2500, 520, 160, 20);
        jPanel36.add(placasunidad2);
        placasunidad2.setBounds(2330, 540, 160, 30);
        jPanel36.add(placasunidad3);
        placasunidad3.setBounds(2500, 540, 160, 30);
        ...
        jPanel36.add(paisx);
        paisx.setBounds(1650, 700, 130, 30);
        ...
        jPanel36.add(estx);
        estx.setBounds(1790, 700, 190, 30);
        ...
        jLabel115.setBounds(2160, 680, 160, 20);
        ...
        jToggleButton1.setBounds(2670, 700, 230, 30);
        ...
        edicion1.setBounds(30, 330, 290, 20);
        ...
        jLabel112.setBounds(160, 310, 160, 20);
        ...
        cajachasisboxExterno.setBounds(2140, 150, 160, 30);
        ...
        jLabel118.setBounds(1990, 460, 160, 20);
        ...
        jLabel119.setBounds(2140, 130, 160, 20);
        ...
        jPanel36.add(Fullx);
        Fullx.setBounds(1650, 180, 300, 16);
        ...
        jPanel36.add(Fullx1);
        Fullx1.setBounds(1790, 180, 160, 16);

        jLabel120.setText("Sello Complementario");
        jLabel120.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jPanel36.add(jLabel120);
        jLabel120.setBounds(2330, 680, 160, 20);
        jPanel36.add(sellocomplementario);
        sellocomplementario.setBounds(2330, 700, 160, 30);

        jLabel24.setText("CLIENTE");
        jLabel24.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jPanel36.add(jLabel24);
        jLabel24.setBounds(20, 80, 90, 17);

        jPanel32.setMinimumSize(new java.awt.Dimension(10, 30));
        jPanel32.setPreferredSize(new java.awt.Dimension(30, 25));
        jPanel36.add(jPanel32);
        jPanel32.setBounds(530, 30, 110, 34);

        jLabel43.setText("Fecha Termino");
        jLabel43.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel43.setForeground(new java.awt.Color(51, 51, 51));
        jPanel36.add(jLabel43);
        jLabel43.setBounds(530, 10, 160, 20);

        try {
            txtHLlegada1.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("##:##")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        txtHLlegada1.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtHLlegada1.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jPanel36.add(txtHLlegada1);
        txtHLlegada1.setBounds(640, 30, 50, 30);
        jPanel36.add(ttl);
        ttl.setBounds(610, 130, 90, 30);
        ...
        jLabel84.setText("Perfil Cobro");
        jPanel36.add(jLabel84);
        jLabel84.setBounds(360, 110, 240, 15);

        jButton23.setFont(new java.awt.Font("Tahoma", 0, 9)); // NOI18N
        jButton23.setText("Calcular Total");
        ...
        jButton23.setBounds(700, 130, 90, 30);
        ...
        jLabel6.setBounds(10, 160, 190, 30);
        ...
        conceptofacturacion.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        conceptofacturacion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                conceptofacturacionActionPerformed(evt);
            }
        });
        Perfiles.getContentPane().add(conceptofacturacion);
        conceptofacturacion.setBounds(220, 530, 260, 30);
        ...
        pEstados11.add(jLabel77, java.awt.BorderLayout.NORTH);
        ...
        pEstados11.add(perfilBuscador, java.awt.BorderLayout.PAGE_END);

        jPanel3.add(pEstados11);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (opt == 0) {
            ...
            /*if (InOut.getSelectedItem().equals("Salida") && statx.equals("Inactivo (F/S)")) {
                JOptionPane.showMessageDialog(dEntradaSalida, "El contenedor esta en status Inactivo (F/S), asegurese de activarlo antes de querer darle salida.", "Error", JOptionPane.ERROR_MESSAGE);
            } else {*/

                if (!txtContenedor.getText().equals("") /*&& cliente.getSelectedIndex() >= 0 && cliente1.getSelectedIndex() >= 0 && !CARRIER.getText().equals("")
                        && ((!placasunidad.getText().equals("") || !placasunidad1.getText().equals("")))
                        && ((!placasunidad2.getText().equals("") || !placasunidad3.getText().equals("")))
                        && (!txtPlacasChasis.getText().equals("") || txtPlacasChasis.getText().equals("") && botando.isSelected())
                        && (!txtSello.getText().equals("") && boxEstadoCarga.getSelectedIndex() == 1 || boxEstadoCarga.getSelectedIndex() == 0)
                        && grade.getSelectedIndex() >= 0 && boxChofer.getSelectedIndex() >= 0 && !licencia.getText().equals("")
                        && camionx.getSelectedIndex() >= 0 && estx.getSelectedIndex() >= 0 && paisx.getSelectedIndex() >= 0*/) {
                    // pal pusho
                    if (patio_usuario.equals(PatioID.get(Patio.getSelectedIndex())) || super_usuario.equals("1") || multipatio.equals("1")) {

                        if (InOut.getSelectedItem().toString().equals("Entrada") && !checkEntrada.equals("") /*&& !checkEntradaCamion.equals("") && !checkEntradaChassis.equals("")*/) {

                            if (!checkEntrada.equals("")) {
                                JOptionPane.showMessageDialog(dEntradaSalida, "El contenedor se encuentra en el patio " + checkEntrada + "./nFavor de darle salida primero.", "Error", JOptionPane.ERROR_MESSAGE);
                            }
                            /*if (!checkEntradaCamion.equals("")) { // aun no se usaran estis mensajes
                                JOptionPane.showMessageDialog(dEntradaSalida, "El camion encuentra en el patio " + checkEntradaCamion + "./nFavor de darle salida primero.", "Error", JOptionPane.ERROR_MESSAGE);
                            }
                            if (!checkEntradaChassis.equals("")) {
                                JOptionPane.showMessageDialog(dEntradaSalida, "El chasis se encuentra en el patio " + checkEntradaChassis + "./nFavor de darle salida primero.", "Error", JOptionPane.ERROR_MESSAGE);
                            }*/

                        } else if (InOut.getSelectedItem().toString().equals("Salida") && !checkSalida.equals("") /*&& !checkSalidaCamion.equals("") && !checkSalidaChasis.equals("")*/) {
                            ...
                            //if(!checkSalidaCamion.equals("")) JOptionPane.showMessageDialog(dEntradaSalida, "El camion no se encuentra en el patio, favor de darle entrada primero.", "Error", JOptionPane.ERROR_MESSAGE);
                            //if(!checkSalidaChasis.equals("")) JOptionPane.showMessageDialog(dEntradaSalida, "El chasis no se encuentra en el patio, favor de darle entrada primero.", "Error", JOptionPane.ERROR_MESSAGE);
                            ...
                            if (!txtContenedor.getText().equals("")) { //&& Orgn.getSelectedIndex()>0 && !placasunidad.getText().equals("") && !NCHASIS.getText().equals("") && !txtNota.equals("")
                                ...
                                if (boxEstadoCarga.getSelectedIndex() == 1 && txtSello.getText().equals("")) {
                                    ...
                                    try {
                                        String fsalida = null, fllegada = null, fsalidax = null, usuariosalida = "0", usuariollegada = "0", patiousuario = utils.dbConsult("SELECT PatioID from usuarios_tbl where UsuarioID = '" + global.usuario + "'");
                                        ...
                                        if (utils.validarDATE(FechaFinal.getText()) && utils.dbConsult("SELECT digits('" + txtHLlegada1.getText() + "')").length() == 4) {
                                            fsalidax = "'" + utils.dateFromFieldtoDBwoH(FechaFinal.getText()) + " " + txtHLlegada1.getText() + ":00'";
                                        }
                                        ...
                                        if (invid.equals("0")) {
                                            ...
                                            //if (cont.equals("0")) {
                                                ...
                                                String salidaDebeTenerEntrada = utils.dbConsult("SELECT IFNULL((SELECT inventarioID "
                                                ...
                                                if (!salidaDebeTenerEntrada.equals("0") || InOut.getSelectedItem().equals("Entrada")) {
                                                    ...
                                                    TempAnteriorID = utils.dbConsult(" select inventarioID "
                                                            + "from inventarioexterno_tbl as i where contenedor = '" + txtContenedor.getText() + "' and TipoEvento=1 "
                                                            + "and (select inventarioexterno_tbl.inventarioID from inventarioexterno_tbl where inventarioexterno_tbl.anteriorID=i.`InventarioID`) is null "
                                                            + " " + vt + " order by inventarioID desc limit 1 "); //and patioID='"+utils.dbConsult("select patioID from usuarios_Tbl where usuarioID='"+global.usuario+"'")+"'
                                                    ...
                                                    String id = utils.dbInsert("INSERT INTO inventarioexterno_tbl (Contenedor, PlacasChasis,  Sello, PaisID, EstadoID, EstadoUSAID,ChoferID, NombreChofer, FechaEvento, " //PlacasChasisUSA,
                                                            ...
                                                            + "remolquePais, remolqueEstado, solochasis,CreacionUsuarioEventoID, licencia, cajaID, chasis, isFull, FullItinerarioBase, sellocomplementario, totalrenta) "
                                                            ...
                                                            + "'" + fulliti + "', '" + sellocomplementario.getText() + "', '"+ttl.getText()+"' )");
                                                    
                                                    
                                                    // cierre de renta
                                                    
                                                    
                                                    utils.dbInsert("INSERT INTO inventarioexterno_tbl (Contenedor, PlacasChasis,  Sello, PaisID, EstadoID, EstadoUSAID,ChoferID, NombreChofer, FechaEvento, " //PlacasChasisUSA,
                                                            + "UsuarioEventoID, Nota, EstadoCarga, UsuarioID, Fecha, Tamano,clienteID, WContenedorID, TipoEvento, AnteriorID, camion, EquipmentProvider, Origen, camionID, botando,"
                                                            + "PlacasUnidad, PlacasUnidadUSA, Destino, NumeroChasis, Carrier, patioID, grade, assignedto, fechaedicion, isCamion, perfilCobroID, isVirtual, itinerarioID, EstadoPlacasMex, EstadoPlacasUsa,"
                                                            ...
                                                            + "VALUES(RTRIM('" + txtContenedor.getText() + "'), '" + txtPlacasChasis.getText() + "',  '" + txtSello.getText() + "', " //'" + txtPlacasChasis1.getText() + "',
                                                            + "'" + (boxPaisPlacas.getSelectedIndex() + 1) + "', '" + estadosid.get(boxEstadoPlacas.getSelectedIndex()) + "', '" + estadosid1.get(boxEstadoPlacas1.getSelectedIndex()) + "' "
                                                            + ",'" + chofereslocalid.get(boxChofer.getSelectedIndex()) + "', '" + txtNombreChofer.getText() + "', " + fsalidax + ", "
                                                            + "'" + usuariollegada + "', '" + txtNota.getText() + "', '" + boxEstadoCarga.getSelectedIndex() + "', '" + global.usuario + "'"
                                                            + ", (now()),  '" + boxTamano.getSelectedItem() + "','" + clienteid.get(cliente.getSelectedIndex()) + "', '" + WContID + "', "
                                                            + "2, '" + id + "', "
                                                            + "'" + camiones.getText() + "', '" + cliente1id.get(cliente1.getSelectedIndex()) + "', '" + Orgn.getSelectedItem().toString() + "', '" + camionidx.get(camionx.getSelectedIndex()) + "', "
                                                    ...
                                                    /* Mantenimiento
                                        String mantenimiento = utils.dbConsult("select * from inventarioexterno_tbl where inventarioID='"+id+"'");
                                        if(!mantenimiento.equals("") && grade.getSelectedIndex()>0 ) {
                                            
                                            utils.dbInsert("INSERT INTO requimant_tbl(ChoferID,CategoriaID,CamionID,Status,Odometro,Tipo,Descripcion,Fecha,FechaRegistro,rev90,onlyRequi,FechaI,tallerID,servicio,"
                                            + "servicio_tren, servicio_post, unidad_externa, departamentoID, inspeccionanual, equipmentproviderid,usuarioID,estadocarga,typeinserted) "
                                            + "VALUES('" + choferesid.get(boxChoferes.getSelectedIndex()) + "','"+categoriasid.get(boxCategoria.getSelectedIndex())+"','" + unidadid.get(boxUnidades.getSelectedIndex()) + "',"
                                            + "'" + boxStatus.getSelectedIndex() + "',(SELECT digits('" + txtOdometro.getValue() + "')),'" + boxTipoMantenimiento.getSelectedIndex() + "','" + text + "',(now()),(now()), "
                                            + ""+rev90.isSelected()+", "+onlyRequi.isSelected()+", " + inicio + ", '"+tallerid.get(taller.getSelectedIndex())+"', "+servicio.isSelected()+", "
                                            + " "+servicio1.isSelected()+", "+servicio2.isSelected()+", '"+ext.getText()+"', '"+dptoID.get(dpto.getSelectedIndex())+"', "+jCheckBox3.isSelected()+", "
                                            + " '"+cliente1id.get(cliente1.getSelectedIndex())+"', '"+global.usuario+"', '"+boxEstadoCarga.getSelectedIndex()+"', 1 ) ");
                                        }*/
                                 ...
                                 + "InventarioID != '" + invid + "' and TipoEvento=IF('"+InOut.getSelectedItem().toString()+"'='Entrada',1,2)),0)");*/
                                            ...
                                            String cot2 = utils.dbConsult("SELECT IFNULL((SELECT IF( '" + InOut.getSelectedItem().toString() + "'='Entrada', IF(AnteriorID=0,InventarioID,0), IF(AnteriorID=0,0,InventarioID)  ) "
                                                    + "from inventarioexterno_tbl where Contenedor = RTRIM('" + txtContenedor.getText() + "') and Status = 1 and inventarioID!='" + invid + "' "
                                            ...
                                            //if (cot2.equals("0")) {
                                                ...
                                                if (!cont.equals("0")) {
                                                    String up = utils.dbUpdate("UPDATE inventarioexterno_tbl SET "
                                                            ...
                                                            + "sellocomplementario='" + sellocomplementario.getText() + "', totalrenta='"+ttl.getText()+"' "
                                                            + "where InventarioID = '" + invid + "' ");
                                                            
                                                            if(InOut.getSelectedItem().toString().equals("Entrada")) { 
                                                                utils.dbUpdate("UPDATE inventarioexterno_tbl SET FechaEvento="+fsalidax+" where AnteriorID='"+invid+"'"); 
                                                                utils.dbUpdate("UPDATE inventarioexterno_tbl SET FechaEvento="+fllegada+" where InventarioID='"+invid+"'"); 
                                                            }
                                                            
                                                            else { 
                                                                
                                                                utils.dbUpdate("UPDATE inventarioexterno_tbl SET FechaEvento="+fsalidax+" where InventarioID='"+invid+"'"); 
                                                                
                                                                utils.dbUpdate("UPDATE inventarioexterno_tbl SET FechaEvento="+fllegada+" where inventarioID="
                                                                + "'"+utils.dbConsult("select anteriorID from inventarioexterno_tbl where inventarioID='"+invid+"' limit 1")+"'"); 
 ...
 /*String estadomex = utils.dbConsult("select EstadoID from inventarioexterno_tbl where inventarioID='"+InventarioSalidaID+"'");
    ...
    private void bContenedoresActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bContenedoresActionPerformed
        try {
            ...
            JasperDesign jd = JRXmlLoader.load(global.path+"Inventario_Cajas_Mexcal.jrxml");
            jd.setQuery(query);
            ...
            Logger.getLogger(ItinerarioGuardiasContExternosRentas.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void bContenedores1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bContenedores1ActionPerformed
        try {
            ...
            /*String source = getClass().getResource("Almacen_Produccion_Filtrado.jrxml").toString();
             System.out.println(source);*/
            JasperDesign jd = JRXmlLoader.load(global.path+"Inventario_Cajas_Cliente.jrxml");
            jd.setQuery(query);
    ...
    private void bContenedores2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bContenedores2ActionPerformed
        ...
        try {
            ...
            /*String source = getClass().getResource("Almacen_Produccion_Filtrado.jrxml").toString();
             System.out.println(source);*/
            JasperDesign jd = JRXmlLoader.load(global.path+"ReporteInventarioAMPL.jrxml");
            jd.setQuery(query);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(BoxCliente.getSelectedIndex()>0 ) { //&& perfilBuscador.getSelectedIndex()>0
            ...
            others.dNuevoDoc frame = new others.dNuevoDoc(this,true,true, BoxClienteID.get(BoxCliente.getSelectedIndex()), "1");
...
//            FillCombo.cargarUnidadesNegocio(frame.boxUNegocio, frame.unegocioid, "");
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    frame.inventarioID.add(rs.getString("inventarioID"));
    ...
    void genReportCobro(String id) {
        try {
            ...
            boolean folderExist = new File(global.path+"AMPLCobros\\").exists();
            if(!folderExist){
                Boolean folder = (new File(global.path+"AMPLCobros\\")).mkdir();
                if(folder){
...
//           Facturacion.setVisible(false);
 ...
 /*if (id.length() < 11 && !id.isEmpty()) {
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        utils.dbInsert("INSERT INTO patios_tbl (`Codigo`, `Nombre`, `Direccion`, `DireccionCorta`, `TipoPatio`, `Status`, `MostrarLFD`, vt, Renta) "
                + "VALUES ('" + pwd.getText() + "', '" + pwd.getText() + "', ' ', ' ', 'TJ', true, false, true, true)");
        cargarAccesos();
        cargarPatiosVirtuales(BoxPatios, patiosid, "Todos");
...
//        }
    ...
    private void txtNombreChoferActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtNombreChoferActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtNombreChoferActionPerformed
    ...
    private void jButton23ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton23ActionPerformed
        ...
        String dias = utils.dbConsult("SELECT (DATEDIFF(date('" + utils.dateFromFieldtoDBwoH(FechaFinal.getText()) + "'),"
        + "date('" + utils.dateFromFieldtoDBwoH(txtFLlegada2.getText()) + "'))+1)");
        
        ttl.setText(utils.dbConsult("select ("+dias+"+0) * "
        + "ROUND(IFNULL((select costo from perfilcobro_rango "
        +"where perfilID='" + perfilBuscador1ID.get(perfilBuscador1.getSelectedIndex()) + "' and (minimo+0)<=(select "+dias+"+0) "
        + "and (maximo+0)>=(select "+dias+"+0)  limit 1),0))"));
    }//GEN-LAST:event_jButton23ActionPerformed

    private void conceptofacturacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_conceptofacturacionActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_conceptofacturacionActionPerformed
    
    private void cargarConceptosFactura() {
        
        String query = "SELECT CargoID, Nombre from conceptoscargosclientes_tbl where Status = true and MostrarFDirecta = true order by Nombre ";
        
        conceptofacturacion.removeAllItems();
        conceptofacturacionid.clear();
        Connection con = null;
        Statement state = null;
        ResultSet rs = null;
        try {
            ...
            rs = state.executeQuery(query);
            while (rs.next()) {
                conceptofacturacionid.add(rs.getString("CargoID"));
                conceptofacturacion.addItem(rs.getString("Nombre"));
            }
        } catch (SQLException e) {
            System.out.println("Error " + e);
        } finally {
    ...
    void cargarAccesos() {
        ...
        String query = "SELECT patioID, nombre from patios_tbl where vt is true";
        Connection con;
        con = utils.startConnection();
    ...
    private void resetter() {
        ...
        cliente1.setSelectedIndex(0);
            ...
            System.out.println("Error al cargar cliente1: " + ew);
        }
        ...
        Patio.setSelectedIndex(0); //PatioID.indexOf(utils.dbConsult("select patioID from usuarios_tbl where usuarioID='" + global.usuario + "'"))
        ...
        txtFLlegada2.setText(fecha.split(" ")[0]);
        txtHLlegada.setText(fecha.split(" ")[1]);
        FechaFinal.setText(fecha.split(" ")[0]);

        /*String airway = "";
        if (Patio.getItemAt(PatioID.indexOf(utils.dbConsult("select patioID from usuarios_tbl where usuarioID='" + global.usuario + "'"))).equals("AIRWAY")) {
            airway = "AIR";
        } else {
            airway = Patio.getItemAt(PatioID.indexOf(utils.dbConsult("select patioID from usuarios_tbl where usuarioID='" + global.usuario + "'")));
        }
    ...
    private void cargarEntradaSalida() {
        ...
        try {
            ...
            ResultSet rs = statement.executeQuery("SELECT Contenedor,"
                    ...
                    + "remolqueEstado, remolquePais, solochasis, itinerarioID, licencia, cajaID, chasis, sellocomplementario, anteriorID, totalrenta "
                    + "from inventarioexterno_tbl "
            ...
            while (rs.next()) {
                ...
                if(rs.getString("Entsal").equals("Entrada")) {
                    
                    txtFLlegada2.setText(rs.getString("fllegada"));
                    txtHLlegada.setText(rs.getString("hllegada"));

                    FechaFinal.setText( utils.dbConsult("select DATE_FORMAT(FechaEvento, '"+global.fdatedb+"') from inventarioexterno_tbl where AnteriorID = '" + inventarioID.get(jTable1.getSelectedRow()) + "'"));
                    txtHLlegada1.setText(utils.dbConsult("select DATE_FORMAT(FechaEvento, '%H:%i') from inventarioexterno_tbl where AnteriorID = '" + inventarioID.get(jTable1.getSelectedRow()) + "'"));
                    ...
                    FechaFinal.setText(rs.getString("fllegada")); 
                    txtHLlegada1.setText(rs.getString("hllegada")); 

                    txtFLlegada2.setText( utils.dbConsult("select DATE_FORMAT(FechaEvento, '"+global.fdatedb+"') from inventarioexterno_tbl where InventarioID = '" + rs.getString("AnteriorID") + "'"));
                    txtHLlegada.setText(utils.dbConsult("select DATE_FORMAT(FechaEvento, '%H:%i') from inventarioexterno_tbl where InventarioID = '" + rs.getString("AnteriorID") + "'"));
                ...
                ttl.setText(rs.getString("totalrenta"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ItinerarioGuardiasContExternosRentas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ItinerarioGuardiasContExternosRentas().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox conceptofacturacion;
    ...
    private javax.swing.JFormattedTextField txtHLlegada1;
